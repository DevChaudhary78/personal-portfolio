...
export default function Container() {
  ...
  return (
    <div className={styles.card_container}>
      ...
      <CardContainer key={`${cards[secondIdx].title}-$${cards[secondIdx].emoji}`} backgroundColor={cards[secondIdx].backgroundColor} title={cards[secondIdx].title} emoji={cards[secondIdx].emoji} text={cards[secondIdx].text} style={smallerCardStyle}/>
...
function CardContainer({ backgroundColor, title, emoji, text, style}: {backgroundColor: string, title: string, emoji: string, text: string, style?: React.CSSProperties}) {
  return(
    <div className={styles.card} style={{ backgroundColor, ...style }}>
